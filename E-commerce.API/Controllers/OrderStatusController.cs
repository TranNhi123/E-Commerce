...
namespace E_commerce.API.Controllers
{
    ...
    public class OrderStatusController : ControllerBase
    {
        ...
        public OrderStatusController(MedicineContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderStatus>> PostOrderStatus(OrderStatus orderStatus)
        {
            ...
            return CreatedAtAction("GetOrderStatus", new { id = orderStatus.ID_TTDH }, orderStatus);
        }
        ...
        {
            return _context.OrderStatuses.Any(e => e.ID_TTDH == id);
        }
    }
}
